...
const validateCreateTip = [
  ...
  body("tipPercentage")
    .notEmpty()
    .withMessage("Tip percentage is required")
    .isNumeric()
    .withMessage("Tip percentage must be numeric"),
  (req, res, next) => {
...
module.exports = { validateCreateTip, validateGetTips };
