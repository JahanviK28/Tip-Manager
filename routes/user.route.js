...
const { validateRegisterUser, validateLoginUser } = require('../middlewares/user.validator');
const router = express.Router();


router.post("/signUp", upload.single("proPic"), validateRegisterUser , async (req, res) => {
  try {
